...
use ennoia_kernel::{
    ...
    HookDispatchResponse, MessageRendererContribution, ModelEndpointConfig, PipelineHandlerSpec,
};
...
pub(crate) struct ExtensionDetailRecord {
    ...
    pipeline_handlers: Vec<PipelineHandlerSpec>,
...
fn map_extension_detail_record(extension: &ResolvedExtensionSnapshot) -> ExtensionDetailRecord {
    ExtensionDetailRecord {
        ...
        pipeline_handlers: extension.pipeline_handlers.clone(),
