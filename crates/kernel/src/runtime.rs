//! Runtime traits: StageMachine, DecisionEngine, Gate pipeline, RuntimeStore.
//!
//! The kernel owns the contracts. Concrete implementations live in the `ennoia-runtime` crate.
...
use crate::{
    ContextView, Decision, DecisionSnapshot, GateRecord, GateVerdict, RunSpec, RunStage,
